...
const messages = {
  fa: {
    appOnline:'اپ دسکتاپ آنلاین است',
    tagline:'دوبلهٔ زنده، بدون دردسر', companionOnline:'همراه محلی آنلاین است', eyebrow:'ترجمه و دوبلهٔ هم‌زمان با Gemini', heroTitle:'هر صدایی را به زبان خودت بشنو.', heroText:'صدای فیلم، کلاس و ویدیو را زنده ترجمه کن؛ صدای اصلی و دوبله را جداگانه کنترل و هر چهار خروجی را ذخیره کن.', start:'شروع دوبله', stop:'توقف دوبله', record:'شروع ضبط', stopRecord:'پایان ضبط', status:'وضعیت', idle:'آماده', connecting:'در حال اتصال', connected:'در حال دوبله', error:'خطا', detectedLanguage:'زبان تشخیص‌داده‌شده', extension:'اکستنشن', notConnected:'متصل نیست', connectedExtension:'متصل است', recording:'ضبط', off:'خاموش', on:'روشن', liveTranscript:'متن زنده', clear:'پاک‌کردن', original:'صدای اصلی', translation:'ترجمه', waitingSource:'منتظر دریافت صدا…', waitingTranslation:'ترجمه اینجا نمایش داده می‌شود…', archive:'آرشیو', latestOutput:'آخرین خروجی', noRecording:'هنوز خروجی‌ای ثبت نشده', recordHint:'هنگام دوبله، ضبط را روشن کن تا چهار فایل هماهنگ ساخته شود.', downloadAll:'دریافت همه', controls:'کنترل‌ها', settings:'تنظیمات', quickSetup:'تنظیم دستی صدای برنامه‌ها', setupDescription:'یک مرحله در Windows Volume Mixer', setupHelp:'برای برنامهٔ دسکتاپ، خروجی همان برنامه باید روی Virtual Cable باشد و LingoDub روی هدفون واقعی پخش کند. اکستنشن به این تنظیم نیاز ندارد.', openWindowsMixer:'باز کردن میکسر صدای ویندوز', audioGuide:'آموزش تصویری تنظیم صدا', targetLanguage:'زبان مقصد', speaker:'گوینده', voiceStyle:'سبک اجرا', captureDevice:'ورودی صدای برنامه', outputDevice:'خروجی شنیداری', soundMix:'ترکیب صدا', soundMixHint:'هر کدام را مستقل بشنو', originalSound:'صدای اصلی', dubbedSound:'صدای دوبله', advanced:'تنظیمات پیشرفته', save:'ذخیره', proxy:'پروکسی', saveSettings:'ذخیرهٔ تنظیمات', saved:'ذخیره شد.', keySaved:'کلید امن ذخیره شد.', keyExists:'کلید API تنظیم شده است', keyMissing:'کلید API را وارد کنید', mixerOpened:'میکسر ویندوز باز شد؛ خروجی برنامهٔ مقصد را روی Virtual Cable بگذارید.', requestFailed:'درخواست انجام نشد', recordingReady:'چهار خروجی آماده است', selectDefault:'پیش‌فرض سیستم', locationUnsupported:'Google این API Key یا موقعیت اتصال را مجاز نمی‌داند؛ حساب و خروجی پروکسی را بررسی کن.'
  },
  en: {
    appOnline:'Desktop app is online',
    tagline:'Live dubbing, minus the friction', companionOnline:'Local companion is online', eyebrow:'Real-time translation and dubbing with Gemini', heroTitle:'Hear anything in your language.', heroText:'Translate movies, classes, and videos live; control source and dubbed audio independently, then save all four synchronized outputs.', start:'Start dubbing', stop:'Stop dubbing', record:'Start recording', stopRecord:'Stop recording', status:'Status', idle:'Ready', connecting:'Connecting', connected:'Dubbing live', error:'Error', detectedLanguage:'Detected language', extension:'Extension', notConnected:'Not connected', connectedExtension:'Connected', recording:'Recording', off:'Off', on:'On', liveTranscript:'Live transcript', clear:'Clear', original:'Original audio', translation:'Translation', waitingSource:'Waiting for audio…', waitingTranslation:'Your translation will appear here…', archive:'ARCHIVE', latestOutput:'Latest output', noRecording:'No output recorded yet', recordHint:'Enable recording while dubbing to create four synchronized files.', downloadAll:'Download all', controls:'CONTROLS', settings:'Settings', quickSetup:'Manual desktop audio setup', setupDescription:'One step in Windows Volume Mixer', setupHelp:'For desktop apps, route that app to a Virtual Cable and play LingoDub through physical headphones. The extension does not need this setup.', openWindowsMixer:'Open Windows volume mixer', audioGuide:'Open the visual audio guide', targetLanguage:'Target language', speaker:'Speaker', voiceStyle:'Delivery style', captureDevice:'Application audio input', outputDevice:'Listening output', soundMix:'Audio mix', soundMixHint:'Listen independently', originalSound:'Original audio', dubbedSound:'Dubbed audio', advanced:'Advanced settings', save:'Save', proxy:'Proxy', saveSettings:'Save settings', saved:'Saved.', keySaved:'Key stored securely.', keyExists:'API key is configured', keyMissing:'Enter an API key', mixerOpened:'Windows mixer opened; route the source app to a Virtual Cable.', requestFailed:'Request failed', recordingReady:'Four outputs are ready', selectDefault:'System default', locationUnsupported:'Google does not allow this API key or connection location; check the account and proxy exit.'
  }
};
