...
|---|---|---|
| Manifest و metadata | ✅ Manifest V3، نسخهٔ `0.8.1` و description کمتر از سقف ۱۳۲ کاراکتر | قبل از هر upload نسخه افزایش یابد و متن با build یکسان بماند |
