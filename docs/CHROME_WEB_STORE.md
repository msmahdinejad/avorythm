...
|---|---|---|
| Manifest و metadata | ✅ Manifest V3، نسخهٔ `0.3.0`، description برابر ۱۰۲ کاراکتر و کمتر از سقف ۱۳۲ | قبل از هر upload نسخه افزایش یابد و متن با build یکسان بماند |
